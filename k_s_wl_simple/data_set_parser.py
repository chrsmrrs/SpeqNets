...
def read_txt(ds_name):
    ...
    with open("../datasets/" + ds_name + "/" + ds_name + "/raw/" + ds_name + "_graph_indicator.txt", "r") as f:
    ...
    # Edges
    with open("../datasets/" + ds_name + "/" + ds_name + "/raw/" + ds_name + "_A.txt", "r") as f:
    ...
    # Node labels
    if path.exists("../datasets/" + ds_name + "/" + ds_name + "/raw/" + ds_name + "_node_labels.txt"):
        with open("../datasets/" + ds_name + "/" + ds_name + "/raw/" + ds_name + "_node_labels.txt", "r") as f:
    ...
    # Node Attributes
    if path.exists("../datasets/" + ds_name + "/" + ds_name + "/raw/" + ds_name + "_node_attributes.txt"):
        with open("../datasets/" + ds_name + "/" + ds_name + "/raw/" + ds_name + "_node_attributes.txt", "r") as f:
    ...
    # # Edge Labels
    # if path.exists("../datasets/" + ds_name + "/" + ds_name + "/raw/" + ds_name + "_edge_labels.txt"):
    #     with open("../datasets/" + ds_name + "/" + ds_name + "/raw/" + ds_name + "_edge_labels.txt", "r") as f:
    ...
    # Edge Attributes
    if path.exists("../datasets/" + ds_name + "/" + ds_name + "/raw/" + ds_name + "_edge_attributes.txt"):
        with open("../datasets/" + ds_name + "/" + ds_name + "/raw/" + ds_name + "_edge_attributes.txt", "r") as f:
