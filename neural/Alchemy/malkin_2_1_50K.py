...
class Alchemy_malkin(InMemoryDataset):
    ...
    def process(self):
        ...
        matrices.extend(pre.get_all_matrices_2_1_malkin("alchemy_full", indices_val))
        matrices.extend(pre.get_all_matrices_2_1_malkin("alchemy_full", indices_test))
