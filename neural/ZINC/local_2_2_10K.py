...
class ZINC(InMemoryDataset):
    ...
    def process(self):
        ...
        matrices = pre.get_all_matrices_2_2("ZINC_train", indices_train)
        matrices.extend(pre.get_all_matrices_2_2("ZINC_val", indices_val))
        matrices.extend(pre.get_all_matrices_2_2("ZINC_test", indices_test))
