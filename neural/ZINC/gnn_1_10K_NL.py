...
class ZINCbase(InMemoryDataset):
    ...
    def process(self):
        ...
        node_labels = pre.get_all_node_labels_ZINC_1(False, False, indices_train, indices_val, indices_test)
        edge_labels = pre.get_all_edge_labels_ZINC_1(False, False, indices_train, indices_val, indices_test)
