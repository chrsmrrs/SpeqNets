...
class TUD_3_2(InMemoryDataset):
    def __init__(self, root, transform=None, pre_transform=None,
                 pre_filter=None):
        super(TUD_3_2, self).__init__(root, transform, pre_transform, pre_filter)
        self.data, self.slices = torch.load(self.processed_paths[0])

    @property
    def raw_file_names(self):
        return "TUD_2df_1ttde2trtgth"

    @property
    def processed_file_names(self):
        return "TUD_2f_erge2dtdt1th"
    ...
    def process(self):
        ...
        node_labels = pre.get_all_node_labels_zinc_3_1(True, True, indices_train, indices_val, indices_test)
...
for _ in range(5):
    ...
    dataset = TUD_3_2(path, transform=MyTransform())
