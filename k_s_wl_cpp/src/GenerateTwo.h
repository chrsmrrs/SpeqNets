...
namespace GenerateTwo {
    ...
    public:
        ...
        Graph generate_local_graph_1(const Graph &g, const bool use_labels, const bool use_edge_labels);
    ...
    private:
        ...
        ColorCounter
        compute_colors(const Graph &g, const uint num_iterations, const bool use_labels, const bool use_edge_labels,
